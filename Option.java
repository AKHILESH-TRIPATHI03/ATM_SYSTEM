...
public class Option extends Account
{
    ...
    public void getLogin() throws IOException{
        ...
        do{
            try {
                data.put(912039, 12345);
                data.put(723605, 54321);
                System.out.println("welcome to ATM PToject!");
               ...
               setPinNumber(menuInput.nextInt());
                ...
                System.out.println("\n" + "invaliud Character(s). Only Numbers." + "\n");
                x=2;
            }
    ...
    System.out.println("Type 3 - Depositww Funds");
